...
pub mod MultisigComponent {
    use multisig_wallet_stark::CustomInterfaceMultisigComponent::{IMultisig, TransactionID, TransactionState};
    ...
    > of IMultisig<ComponentState<TContractState>> {
        ...
        fn confirm_transaction(ref self: ComponentState<TContractState>, id: TransactionID) {
            ...
            // Hummm... u were saying dat is_confirmed_by not trustable?
