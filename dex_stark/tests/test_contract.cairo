...
fn test_price() {
    ...
    assert_eq!(y_out , 831248957812239453, "1-price() is wrong");
    ...
    assert_eq!(y_out , 1359916340820223697, "2-price() is wrong");
}
...
fn test_getLiquidity() {
    ...
    assert_eq!(liquidity , INITIAL_STRK_SUPPLY, "get_liquidity() is wrong");
}
...
fn test_strkToToken_scenario_2() {
    ...
    assert_gt!(receipt2_after_balance , receipt3_after_balance, "strk_to_token() is wrong");
}
...
fn test_tokenToStrk_scenario_1() {
    ...
    println!("-- Expecting final Dex balance to have increased by 1...");
    assert_eq!(dex_token_balance , INITIAL_STRK_SUPPLY + token_input, "Dex token balance is wrong");
}
...
fn test_withdraw_decrease_liquidity() {
    ...
    assert_lt!(total_lp_after , total_lp_before, "Total liquidity should decrease");
    ...
    assert_eq!(liquidity_burned , ONE_TOKEN_UNIT, "Incorrect liquidity burned");
}